...
int main(int argc, char* argv[]) {
    ...
    int* V_paralel_linii = new int[N * M];
    int* V_paralel_coloane = new int[N * M];
    ...
    string output_folder = string(R"(C:\\Users\\razva\\Desktop\\PPD\\rezolvari C++\\rezolvare_alocare_dinamica_cpp\\outputs_lab\\rez_)")
    ...
    // --- PARALEL LINII ---
    string output_filename_par_linii = output_folder + "output_paralel_linii_" + to_string(P) + "threads_N"
        + to_string(N) + "M" + to_string(M) + "k" + to_string(k)
        + "_iteratia" + to_string(iteratie) + ".txt";
    ...
    // --- PARALEL COLOANE ---
    string output_filename_par_col = output_folder + "output_paralel_coloane_" + to_string(P) + "threads_N"
        + to_string(N) + "M" + to_string(M) + "k" + to_string(k)
        + "_iteratia" + to_string(iteratie) + ".txt";
    ...
    delete[] C;
    delete[] V_secvential;
    delete[] V_paralel_linii;
    delete[] V_paralel_coloane;
