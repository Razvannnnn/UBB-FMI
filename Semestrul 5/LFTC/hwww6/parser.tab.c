...
// External declaration for lexer
int yylex();
...
// Helper to define data section variables
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_READ_OP = 7,                    /* READ_OP  */
  YYSYMBOL_WRITE_OP = 8,                   /* WRITE_OP  */
...
{
       0,    67,    67,    67,    67,    72,    73,    77,    85,    86,
      90,    91,    92,    96,   104,   114,   125,   131,   137,   142,
     148,   156,   161,   166,   170
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "MAIN", "CIN",
  "COUT", "READ_OP", "WRITE_OP", "ASSIGN", "PLUS", "MINUS", "MULT", "DIV",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMICOLON", "ID", "INT_CONST",
  "$accept", "program", "$@1", "$@2", "declarations", "declaration",
  "statement_list", "statement", "assign_stmt", "read_stmt", "write_stmt",
...
{
      15,    20,    25,    12,   -33,    13,    11,   -33,   -33,    26,
      14,    -5,   -33,    16,    23,    24,    22,    18,    -5,   -33,
     -33,   -33,   -33,    17,    -3,    -3,   -33,   -33,    19,    -3,
     -33,   -33,    -8,     8,   -33,    -6,   -33,    -2,    -3,    -3,
     -33,    -3,    -3,   -33,   -33,     8,     8,   -33,   -33
};
...
{
       0,     0,     0,     0,     1,     0,     0,     2,     6,     3,
       0,     9,     5,     0,     0,     0,     0,     0,     9,    10,
      11,    12,     7,     0,     0,     0,     4,     8,     0,     0,
      22,    23,     0,    18,    21,     0,    14,     0,     0,     0,
      15,     0,     0,    13,    24,    16,    17,    19,    20
};
...
{
      14,    15,    38,    39,    38,    39,    45,    46,    38,    39,
      40,    29,    43,    44,    16,    35,    30,    31,     1,    37,
      41,    42,    47,    48,     3,     4,     5,     7,     6,    10,
      23,    25,    24,    13,    22,    26,    28,    36,     0,    27
};

static const yytype_int8 yycheck[] =
{
       5,     6,    10,    11,    10,    11,    38,    39,    10,    11,
      18,    14,    18,    15,    19,    25,    19,    20,     3,    29,
      12,    13,    41,    42,     4,     0,    14,    16,    15,     3,
       7,     9,     8,    19,    18,    17,    19,    18,    -1,    18
};
...
{
       0,     3,    22,     4,     0,    14,    15,    16,    23,    25,
       3,    24,    26,    19,     5,     6,    19,    27,    28,    29,
      30,    31,    18,     7,     8,     9,    17,    27,    19,    14,
      19,    20,    32,    33,    34,    32,    18,    32,    10,    11,
      18,    12,    13,    18,    15,    33,    33,    34,    34
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    21,    23,    24,    22,    25,    25,    26,    27,    27,
...
#line 1162 "parser.tab.c"
  ...
  case 4: /* program: INT MAIN LPAREN RPAREN LBRACE $@1 declarations $@2 statement_list RBRACE  */
#line 67 "parser.y"
                                                                                                           { write_epilogue(); }
...
#line 77 "parser.y"
                     {
        add_data_decl((yyvsp[-1].id));
        free((yyvsp[-1].id));
    }
#line 1177 "parser.tab.c"
    break;

  case 13: /* assign_stmt: ID ASSIGN expression SEMICOLON  */
#line 96 "parser.y"
                                   {
        fprintf(asm_out, "\tpop rax\n");        // Get result
        fprintf(asm_out, "\tmov [%s], eax\n", (yyvsp[-3].id)); // Store in variable
        free((yyvsp[-3].id));
    }
#line 1187 "parser.tab.c"
    break;

  case 14: /* read_stmt: CIN READ_OP ID SEMICOLON  */
#line 104 "parser.y"
                             {
        fprintf(asm_out, "\tmov rsi, %s\n", (yyvsp[-1].id));    // Address of var
...
#line 1199 "parser.tab.c"
  ...
  case 15: /* write_stmt: COUT WRITE_OP expression SEMICOLON  */
#line 114 "parser.y"
                                       {
...
#line 148 "parser.y"
                      {
        /* ADDED: Division Logic */
        fprintf(asm_out, "\tpop rbx\n");      // Pop Divisor (Right operand)
        fprintf(asm_out, "\tpop rax\n");      // Pop Dividend (Left operand)
