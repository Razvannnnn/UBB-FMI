...
public class ClientJsonWorker implements Runnable, IObserver {
    ...
    private Response handleRequest(Request request) {
        ...
        if(request.getType() == RequestType.GET_AGE_GROUPS) {
        ...
        if(request.getType() == RequestType.GET_EVENTS) {
        ...
        if(request.getType() == RequestType.GET_EVENTS_BY_AGE_GROUP) {
        ...
        if(request.getType() == RequestType.SAVE_CHILD_AND_ENROLLMENT) {
        ...
        if(request.getType() == RequestType.GET_CHILDREN_BY_EVENT) {
        ...
        if(request.getType() == RequestType.GET_CHILDREN) {
        ...
        if(request.getType() == RequestType.GET_NUMBER_OF_EVENTS) {
        ...
        if (request.getType() == RequestType.GET_DETAILS_FOR_ALL_CHILDREN) {
