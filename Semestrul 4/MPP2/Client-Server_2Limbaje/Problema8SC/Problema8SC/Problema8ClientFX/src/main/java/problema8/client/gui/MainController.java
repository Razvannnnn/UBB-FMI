...
public class MainController implements Initializable, IObserver {
    ...
    private final ObservableList<ChildDetails> modelDetails = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<ChildDetails> tableView2;
    @FXML
    private TableColumn<ChildDetails, String> ageChild2;
    @FXML
    private TableColumn<ChildDetails, String> nameChild2;
    @FXML
    private TableColumn<ChildDetails, String> nrEventsChild2;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        nameChild2.setCellValueFactory(new PropertyValueFactory<>("Name"));
        ageChild2.setCellValueFactory(new PropertyValueFactory<>("Age"));
        nrEventsChild2.setCellValueFactory(new PropertyValueFactory<>("NumberOfEvents"));
    ...
    private void loadChildrenWithDetails() {
        modelDetails.clear();
        List<ChildDetails> childrenDetails = service.getDetailsForAllChildren();
