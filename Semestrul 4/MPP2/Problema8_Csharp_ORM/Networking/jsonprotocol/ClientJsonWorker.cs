...
public class ClientJsonWorker : IObserver
{
    ...
    private Response HandleRequest(Request request)
    {
        ...
        if (request.Type == RequestType.GET_EVENTS_BY_AGE_GROUP)
        {
        ...
        if (request.Type == RequestType.SAVE_CHILD_AND_ENROLLMENT)
        {
        ...
        if (request.Type == RequestType.GET_CHILDREN_BY_EVENT)
        {
        ...
        if (request.Type == RequestType.GET_DETAILS_FOR_ALL_CHILDREN)
        {
