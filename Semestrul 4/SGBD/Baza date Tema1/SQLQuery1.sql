CREATE DATABASE BazaDateSGBD_test2
GO
USE BazaDateSGBD_test2
GO
...
EXEC insert_sponsor_eveniment_full_rollback 
  '', 'invalid@x.com', 'Basic',
  'Eveniment Test_FR', '2025-08-20', 'Test', 1, 1;

-- Data eveniment in trecut
EXEC insert_sponsor_eveniment_full_rollback 
  'Sponsor Valid1', 'valid@x.com', 'Basic',
  'Eveniment Test_FR', '2023-09-21', 'Test', 1, 1;
...
-- Sponsor invalid
EXEC insert_sponsor_eveniment_partial_rollback 
  'Sponsor Invalid', '', 'Silver', 
  'Eveniment Valid', '2025-07-20', 'Descriere', 1, 1;
